package com.arthas.business.utils.file;

import com.arthas.business.utils.AnsiLog;
import com.arthas.business.utils.IOUtils;
import com.arthas.business.utils.StringUtil;
...
public class DownloadUtils {
    ...
    public static void downArthasPackaging(String arthasVersion, final String filename, final String urlString, String savePath) {
        try {
            ...
            String remoteDownloadUrl = urlString;
            ...
            log.error("downArthasPackaging exception ", e);
        }
    }
