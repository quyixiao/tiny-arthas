package com.arthas.agent;

import com.arthas.spy.Spy;
...
public class AgentBootstrap {
    ...
    private static final String ADVICEWEAVER = "com.arthas.core.advisor.AdviceWeaver";
    ...
    private static final String ARTHAS_CONFIGURE = "com.arthas.core.config.Configure";
    private static final String ARTHAS_BOOTSTRAP = "com.arthas.core.server.ArthasBootstrap";
    ...
    public static void premain(String args, Instrumentation inst) {
        ps.println("premain exe");
        main(args, inst);
    }

    public static void agentmain(String args, Instrumentation inst) {
        ps.println("agentmain exe");
        main(args, inst);
    }
