package com.arthas.service.shell.cli;


import com.arthas.service.shell.term.Tty;
import com.arthas.service.usage.StyledUsageFormatter;
import com.arthas.service.utils.SearchUtils;
import com.arthas.service.utils.StringUtils;
...
public class CompletionUtils {
    ...
    public static void completeUsage(Completion completion, CLI cli) {
        Tty tty = completion.session().get(com.arthas.service.shell.session.Session.TTY);
