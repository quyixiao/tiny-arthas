package com.arthas.service.shell.command;


import com.arthas.service.shell.cli.Completion;
import com.arthas.service.shell.cli.CompletionUtils;
...
public abstract class AnnotatedCommand {
     ...
     * or {@link com.arthas.service.shell.cli.Completion#complete(String, boolean)} )} method to signal completion is done.
     *
