package com.arthas.business.utils.shell;
...
public class ExecutingCommand {
    ...
    private static final Logger log = Logger.getLogger(ExecutingCommand.class);
    ...
    public static List<String> runNative(String[] cmdToRunWithArgs) {
        ...
        try {
            ...
            log.info("Couldn't run command :" + Arrays.toString(cmdToRunWithArgs), e);
        ...
        try {
            ...
            log.info("Problem reading output from :" + Arrays.toString(cmdToRunWithArgs), e);
            return new ArrayList<String>(0);
        } catch (InterruptedException ie) {
            log.info("Problem reading output from :" + Arrays.toString(cmdToRunWithArgs), ie);
