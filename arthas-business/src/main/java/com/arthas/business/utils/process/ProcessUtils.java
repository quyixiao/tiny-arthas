package com.arthas.business.utils.process;

import com.arthas.business.utils.AnsiLog;
import com.arthas.business.utils.IOUtils;
import com.arthas.business.utils.JavaVersionUtils;
import com.arthas.business.utils.shell.ExecutingCommand;
import com.arthas.business.utils.shell.PidUtils;
...
public class ProcessUtils {
    ...
    public static Map<Integer, String> listProcessByJps(boolean v) {
        ...
        AnsiLog.info("Try use jps to lis java process, jps: " + jps);
    ...
    public static void startArthasCore(int targetPid, List<String> attachArgs) {
        ...
        AnsiLog.info("java home = " + javaHome);
        // find java/java.exe
        File javaPath = findJava();
        AnsiLog.info("java path = " + javaPath.getAbsolutePath());
        if (javaPath == null) {
        ...
        AnsiLog.info("toolsJar path = " + toolsJar.getAbsolutePath());
        ...
        // /usr/local/jdk1.8.0_74/jre/../bin/java
        // -Xbootclasspath/a:/usr/local/jdk1.8.0_74/jre/../lib/tools.jar                                后缀在核心class搜索路径后面.常用!!
        // -jar
        // /home/admin/tiny-arthas/arthas-core.jar
        // -pid
        // 23553
        // -target-ip
        // 127.0.0.1
        ...
        // /home/admin/tiny-arthas/arthas-core.jar
        // -agent
        // /home/admin/tiny-arthas/arthas- agent.jar
            ...
            Thread redirectStderr = new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        e.printStackTrace();
                        com.arthas.business.utils.IOUtils.close(inputStream);
                    }
                }
            });
